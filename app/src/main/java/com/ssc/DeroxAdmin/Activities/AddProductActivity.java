...
public class AddProductActivity extends AppCompatActivity implements OnClickListener {
    ...
    private void setViews() {
        ...
        mVisibilitySwitch.setChecked(partNo.isVisibility());
        key = partNo.getUid();
    ...
    private void FindIds() {
        ...
        mVisibilitySwitch = findViewById(R.id.visibility_Switch);
    }
    ...
    private void AddButton() {
        ...
        result.put("visibility", mVisibilitySwitch.isChecked());
