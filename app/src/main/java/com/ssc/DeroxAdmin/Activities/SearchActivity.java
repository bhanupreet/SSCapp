package com.ssc.DeroxAdmin.Activities;
...
import com.ssc.DeroxAdmin.Fragments.ProductListFragment;
...
//                        FirebaseDatabase.getInstance().getReference().child("PartNoList").child(snapshot.getKey()).child("visibility").setValue(true);
//                        if (partNo.isVisibility())
                            mList.add(partNo);
                    }
                }
