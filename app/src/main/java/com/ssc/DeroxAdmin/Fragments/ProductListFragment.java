package com.ssc.DeroxAdmin.Fragments;
...
import com.ssc.DeroxAdmin.Activities.AddProductActivity;
import com.ssc.DeroxAdmin.Activities.ProductListActivity;
import com.ssc.DeroxAdmin.Adapter.ProductListAdapter;
import com.ssc.DeroxAdmin.Model.PartNo;
...
import static com.ssc.DeroxAdmin.Activities.ProductListActivity.getFab;
        ...
        adapter.addItemClickListener((position, animatedview) -> {
            if (multiselect) {
                ...
                getFragmentManager()
                        ...
                        .commit();
//                Toast.makeText(getContext(), mList.get(posiition).getCompanyname(), Toast.LENGTH_SHORT).show();
            }
        });
...
//                            && snapshot.getValue(PartNo.class).isVisibility()
                    ) {
                        mList.add(partNo);
